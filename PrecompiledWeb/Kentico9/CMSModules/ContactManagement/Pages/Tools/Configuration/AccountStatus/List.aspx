<%@ page language="C#" autoeventwireup="true" masterpagefile="~/CMSMasterPages/UI/SimplePage.master" title="Account status list" inherits="__ASPNET_INHERITS" theme="Default" %>
